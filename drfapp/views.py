...
#Generic Api views with model mixins but in a single class multiple functionalities

class StudentRUDGenericMixinClass(GenericAPIView, RetrieveModelMixin, UpdateModelMixin, DestroyModelMixin):
    queryset = Student.objects.all()
    serializer_class = StudentSerializer
...
class StudentListAndCreateGenericMixinClass(GenericAPIView, ListModelMixin, CreateModelMixin):
    queryset = Student.objects.all()
    serializer_class = StudentSerializer
